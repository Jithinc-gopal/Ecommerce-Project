...
export const Readingglasses = () => {
  ...
  useEffect(()=>{
    ...
    .then((res)=>{
      const item  = res.data.filter((product)=>product.category ==="Reading glasses"
...
const handleAddToCart = async (product) => {
  ...
  <p style={{ fontSize: "1.2rem", color: "#555", marginTop: "10px" }}>
    Enhance your reading comfort with lightweight, durable, and stylish reading glasses designed for everyday clarity and ease.
  </p>
</div>
