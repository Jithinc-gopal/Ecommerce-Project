...
export const Sunglasses = () => {
  ...
  useEffect(()=>{
    ...
    .then((res)=>{
      const item  = res.data.filter((product)=>product.category ==="Sunglasses"
...
const handleAddToCart = async (product) => {
  ...
  <p style={{ fontSize: "1.2rem", color: "#555", marginTop: "10px" }}>
    Discover our stylish range of sunglasses with UV protection, polarized lenses, and modern designs to keep your eyes safe and your look on point.
  </p>
</div>
